...
public class PickupSubsystem extends SubsystemBase {
  ...
  public PickupSubsystem() {
    ClawCylinder = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, PickupConstants.kPickupClawSolenoidRetractChannel, PickupConstants.kPickupClawSolenoidExtendChannel);
  }
